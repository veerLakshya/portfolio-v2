import type { StackLayer } from "../../../types/types";
...
export function StackCell({ layer }: StackCellProps) {
  return (
    <article className="flex flex-col gap-4 bg-[#1a262b66] px-6 py-10 backdrop-blur-[5px] transition-colors hover:bg-white/5">
      <p className="font-mono text-[11px] uppercase tracking-widest text-[#d4b895]">
        {layer.id}
      </p>
