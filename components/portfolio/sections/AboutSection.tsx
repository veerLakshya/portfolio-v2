    ...
    >
      <div className="grid gap-10 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <p className="max-w-170 text-lg leading-8 text-white/70">
            I don&apos;t just write code; I build systems. Navigating the
            complexity of modern software engineering requires more than syntax,
            it requires structure, intuition, and a relentless focus on the user
            experience.
          </p>
        </div>
      </div>
      ...
      <div className="mt-20 flex flex-col gap-10 border-t border-white/15 pt-10 lg:flex-row lg:justify-between">
        {values.map((value) => (
          <div key={value.title} className="flex-1 pr-0 lg:pr-10">
            ...
            <p className="max-w-75 text-sm leading-7 text-white/70">
              {value.text}
            </p>
          </div>
        ))}
